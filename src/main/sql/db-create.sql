...
CREATE TABLE users
(
    user_id     NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY CONSTRAINT pk_user PRIMARY KEY,  --TODO TRIGGER ADDING AUTOMATIC ID
...
(
    ...
    club_id         NUMBER NOT NULL CONSTRAINT club_pk PRIMARY KEY, --TODO TRIGGER FOR AUTOMATIC CLUB ID
